...
static gps_ellipsoid ellipsoids[]=
{
...
int main(void)
{
	...
	while(datums_known[i].name)
	{
		printf("  * %s\n", datums_known[i].name);
		
		int j = datums_known[i].ellipse;

		printf("<datum name=\"%s\" ", datums_known[i].name);
		printf("ellipsoid=\"%s\" ", ellipsoids[j].name);
		printf("a=\"%f\" ", ellipsoids[j].a);
		printf("invf=\"%f\" ", ellipsoids[j].invf);
		printf("dx=\"%f\" ", datums_known[i].dx);
		printf("dy=\"%f\" ", datums_known[i].dy);
		printf("dz=\"%f\"", datums_known[i].dz);
		printf("/>\n");
