 ...
 */
  ...
  { /* no errors */
    ...
    Set_Lambert_2_Parameters(Neys_a, Neys_f, Neys_Origin_Lat, Neys_Origin_Long,
 ...
 */
  ...
  { /* no errors */
    ...
    temp_Error = Convert_Geodetic_To_Lambert_2(Latitude, Longitude, Easting, Northing);
    
    if (temp_Error & LAMBERT_2_LAT_ERROR)
      Error_Code |= NEYS_LAT_ERROR;
 ...
 */
  ...
  { /* no errors */
    ...
    temp_Error = Convert_Lambert_2_To_Geodetic(Easting, Northing, Latitude, Longitude);
   
    if (temp_Error & LAMBERT_2_EASTING_ERROR)
      Error_Code |= NEYS_EASTING_ERROR;
    if (temp_Error & LAMBERT_2_NORTHING_ERROR)
      Error_Code |= NEYS_NORTHING_ERROR;
